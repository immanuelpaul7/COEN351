...
if ($submit)
{
	...
	if($user == $username)
	{
		...
		<table>
        		...
        		<tr>
                    ...
                    <td>
                    <input type="text" name="ans" size="40"value="Enter Answer Here">
                    <input type="hidden" name="ans1" value="'.$question.'">
					<input type="hidden" name="ans2" value="'.$username.'">
					<input type="Submit" name="answerent" value="Submit">
                    </td>
               </tr>
         </table>
			</form> ';	
	...
	{
		echo "<br/>Please Enter the Valid User Name<br/>";
		echo "<a href='forgot.php'>Click Here</a>";
	}
}
?>