...
$query = mysql_query("SELECT * FROM `users` WHERE `logged_in` = 1", $connect);
$username = mysql_result($query, 0, 'username');
$query1 = mysql_query("update `users` set `logged_in` = 0 WHERE `username`='$username'", $connect);
...
<center>
HTML;
		echo "<br/><b>Success!!!&nbsp;<i>".$username."</i><br/>You have logged out </b>";
		echo "<a href='index.php'>Click here</a> to return.</center></div></body></html>";
