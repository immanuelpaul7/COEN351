...
text-align: center;
	...
	<head>
		...
		<br/><h1>Welcome to the forum page</h1>
	</head>
	<body>
...
<?php
//include 'post_forum.php';
include 'copypost.php';
...
echo <<<HTML
		<form method = "post">
		<div style="margin-left: 40%;margin-right: 40%;position:inherit;">
   		<br/><br/>
		<a href="createtopics.php"><h3 align="center"><input type="button" value="Create a Topic"/></h3></a>&nbsp;	
			</div>		
		</form>
...
HTML;
		...
		$query = 'select * from topics order by date asc';
		$result = mysql_query($query,$connect) or die("not working"); 
		echo '<div class="tabla" align="center">
				<table width = "100%" border = "2">
					<center>
					 <tr> <th> Topic </th> <th> Created By </th><th> Created Date </th>';	
		$y = 1;
		for($i=0;$i<mysql_num_rows($result);$i++)
		{
			
			$topics = mysql_result($result, $i, 'topics');
			$user = mysql_result($result, $i, 'user');		
			$index = mysql_result($result, $i, 'index');
			$date = mysql_result($result, $i, 'date');
		//<th> Index No </th> 	<td align="center"> '.$i.'</td>
			echo '
					<tr> 
       				<td width = "30%" align="center"><a href="forum.php?posted='.$y.'"><b>'.$topics.'</b></a></td>
       				<td align="center"><i>'.$user.'</i></td>
