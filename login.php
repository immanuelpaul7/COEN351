...
$query = mysql_query("SELECT * FROM users WHERE username='$username'", $connect) or die(mysql_error());
//$activate = mysql_result($query, 0 , 'activationkey'); 
...
if($numrows!=0)
{
	...
	
	{
		if($activate == '')
		{
		echo "<br/><b>Weclome,<i> ".$dbusername."</i><br/><a href='final.php'>Continue browsing</a></b>";
		$_SESSION['username']= $username;
		$_SESSION['loggedin'] = TRUE;
		$query1 = mysql_query("update users set `logged_in` = 1 WHERE username='$username'", $connect);
		}
		else
		{
		echo "<br/><b>Weclome,<i> ".$dbusername."</i><br/>You have to activate your account from your email.</b>";
		}
